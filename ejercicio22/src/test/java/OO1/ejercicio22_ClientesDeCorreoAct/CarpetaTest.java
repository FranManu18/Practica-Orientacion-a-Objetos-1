...
public class CarpetaTest {
	...
	@Test
	public void testCantEmails() {
		assertEquals(2,carpeta.cantMails());
	}
	
	@Test
	public void testEmailPorTamaño(){
		BagImpl<String> resultado = carpeta.mailsPorTamaño();

	    assertEquals(2, resultado.occurrencesOf("Pequeño")); 
	    assertEquals(0, resultado.occurrencesOf("Mediano"));
	    assertEquals(0, resultado.occurrencesOf("Grande"));
	}
}
